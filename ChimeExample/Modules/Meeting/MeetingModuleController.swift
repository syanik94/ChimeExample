...
class MeetingModuleController: NSObject {
    // Dependencies
    ...
    init(username: String, meetingID: String, meetingConfiguration: MeetingSessionConfiguration) {
        ...
        self.meetingSessionConfig = meetingConfiguration
        super.init()
    }
...
extension MeetingModuleController: AudioVideoObserver {
...
extension MeetingModuleController: VideoTileObserver {
...
extension MeetingModuleController: ActiveSpeakerObserver {
