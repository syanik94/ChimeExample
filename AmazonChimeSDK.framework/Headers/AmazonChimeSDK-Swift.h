...
///
- (nonnull instancetype)initWithTopic:(NSString * _Nonnull)topic data:(NSData * _Nonnull)data senderAttendeeId:(NSString * _Nonnull)senderAttendeeId senderExternalUserId:(NSString * _Nonnull)senderExternalUserId timestampMs:(NSInteger)timestampMs throttled:(BOOL)throttled OBJC_DESIGNATED_INITIALIZER;
